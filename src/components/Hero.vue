  ...
  <section id="hero" class="min-h-screen flex items-center pt-20 relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
      ...
      <div class="space-y-8 order-2 lg:order-1">
        ...
        <a href="#contact" class="group relative px-8 py-3 border-2 border-slate-600 dark:border-slate-400 text-slate-700 dark:text-slate-300 rounded-full font-medium overflow-hidden transition-all duration-300 hover:text-white dark:hover:text-slate-900 hover:scale-105 active:scale-95">
